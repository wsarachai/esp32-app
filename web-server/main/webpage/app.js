...
SoilMoistureProgressBar.prototype.changeBackgroundByValue = function (width) {
  if (width <= 40) {
    $(this.bar).css("background", "red");
  } else if (width <= 60) {
    $(this.bar).css("background", "orange");
...
const GeneralInfo = function () {
  ...
  setInterval(this.advanceDisplayEntry.bind(this), 10000);
};
...
GeneralInfo.prototype.setNoDataState = function () {
  if (this.lastSensorDataTime) {
    ...
    this.sensorAvailabilityNotice.innerHTML =
      "No data from server. Showing last values at " + this.lastSensorDataTime;
  } else {
...
GeneralInfo.prototype.updateDisplayEntries = function (
  averageReading,
  nodeReadings,
) {
  const entries = [];
...
RelayControl.prototype.createBodyInfo = function () {
  ...
  this.relayIndicatorTitle = createElement(
    "div",
    {
  ...
  this.relayIndicatorState = createElement(
    "div",
    {
  ...
  this.relayIndicatorMode = createElement(
    "div",
    {
  ...
  this.relayCheckbox.addEventListener(
    "click",
    this.relayCheckbox_Click.bind(this),
  );
...
RelayControl.prototype.setControlMode = function (isManual) {
  this.relayIndicatorMode.innerHTML = isManual
    ? "โหมดกำหนดเอง"
    : "โหมดอัตโนมัติ";
};
...
ConnectivityInfo.prototype.createBodyInfo = function () {
  ...
  webConnectionInfo.appendChild(
    createElement("label", {}, "การเชื่อมต่อ Web:"),
  );
...
ConnectivityInfo.prototype.setClientNodeStatus = function (
  onlineCount,
  registeredCount,
) {
...
ConnectivityInfo.prototype.setWebConnectionStatus = function (
  connectedCount,
  totalCount,
) {
